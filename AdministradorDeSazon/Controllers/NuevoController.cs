...
namespace AdministradorDeSazon.Controllers
{
    public class NuevoController : Controller
    {
        ...
        public NuevoController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> Administrador(AdministradorViewModel model)
        {
